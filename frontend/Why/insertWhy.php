          ...
          <div class="col-lg-8 d-flex align-items-stretch">
            <div class="icon-boxes d-flex flex-column justify-content-center">
              ...
              <?php 
                ...
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    <form id="whyForm" onsubmit="registerWny(event);">
                        Card Positi: 
                        ...
                        Icon:
                          ...
                          <input type="text" name="header" id="header" placeholder="Header..."><br><br>
                          <input type="text" name="content" id="content" placeholder="Header..."><br><br>
